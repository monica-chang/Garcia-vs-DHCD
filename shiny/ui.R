...
shinyUI(
    navbarPage(theme = shinytheme("flatly"), 
        "Garcia vs DHCD",
             ...
             # motivation for my final project.
        ...
        # TODO: Elaborate on this.
            ...
            # I create a tab to display the plot of what percetage of 
            # approved ADA requests are met over time. The user is able to 
            ...
            tabPanel(
              ...
              p("Here is an interactive time plot that shows the percentage of approved ADA requests that are met over time:"),
                 ...
                 # TODO: Define the assumptions and what they mean/why they matter.
              )),
