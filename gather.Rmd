...
fit_obj_tbl <- as_tibble(fit_obj) %>%
  ...
  mutate(request_median = median(req_scattered_site_placement_unit_co_housing_unit)) %>%
  mutate(reason_median = median(reason_mental_health))
