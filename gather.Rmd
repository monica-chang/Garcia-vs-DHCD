...
supplement_date_acc_met <- function(df){
  df %>%
    ...
    mutate(date_acc_met = ifelse(!is.na(date_acc_met), 
                                 ...
                                 # censorship date. ASK: Should I do this?
...
issued_ncs <- read_csv(file = "/Users/monicachang/Documents*/gbls/project/Garcia-vs-DHCD/processed_data/issued_ncs.csv")
...
ada_ncs <- left_join(supplemented_interesting_ada_transfers_t, issued_ncs, by = "pei") %>%
